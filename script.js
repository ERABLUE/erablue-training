...
// ==========================================
// UPGRADE FUNGSI HELPER (SESUAI INSTRUKSI)
// ==========================================
function cariError() {
    ...
    const filtered = masterHelper.filter(item => {
        // Gabungkan Kategori, Merk, dan SN untuk pencarian yang fleksibel
        const combinedString = (item.kategori + " " + item.merk + " " + item.serialNumber).toLowerCase();
        
        // Cek apakah keyword masuk dalam gabungan string tersebut
